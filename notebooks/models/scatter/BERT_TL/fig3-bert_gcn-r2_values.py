#!/usr/bin/env python
"""
PyTorch Lightning BERT-GCN model runner for R^2 values.
"""
import argparse
import os
import torch
...
class LightningBertGcn(L.LightningModule):
    def __init__(self, 
                 ...
                 max_len: int, mask_prob:float, gcn_model: GraphSAGE, 
    ...
    def step(self, batch):
        ...
        _, preds, y = self(masked_tokenized_seqs, targets)
    ...
    def on_fit_end(self):
        ...
        save_as = f"bert_gcn/bert_gcn.{self.script_letter}.{self.binding_or_expression}-predicted_vs_measured.values.csv"

#!/usr/bin/env python
"""
PyTorch Lightning ESM-MLM-FCN model runner for R^2 values.
"""
import argparse
import os
import torch
...
class LightningEsmFcn(L.LightningModule):
    def __init__(self, 
                 ...
                 max_len: int, mask_prob: float, fcn_model: FCN, esm_version="facebook/esm2_t6_8M_UR50D"):
        super().__init__()
    ...
    def on_fit_end(self):
        ...
        save_as = f"esm_mlm_fcn/esm_mlm_fcn.{self.script_letter}.{self.binding_or_expression}-predicted_vs_measured.values.csv"

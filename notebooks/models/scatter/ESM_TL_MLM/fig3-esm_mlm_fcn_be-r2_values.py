#!/usr/bin/env python
"""
PyTorch Lightning ESM-MLM-FCN BE model runner for R^2 values.
"""
import argparse
import os
import torch
...
class LightningEsmFcnBe(L.LightningModule):
    def __init__(self, 
                 ...
                 max_len: int, mask_prob: float, fcn_model: FCN_BE, esm_version="facebook/esm2_t6_8M_UR50D"):
        super().__init__()
    ...
    def on_fit_end(self):
        ...
        save_as = f"esm_mlm_fcn_be/esm_mlm_fcn_be.{self.script_letter}-predicted_vs_measured.values.csv"

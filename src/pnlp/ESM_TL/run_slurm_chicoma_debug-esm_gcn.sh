...
#SBATCH --output=logs/esm_mlm_gcn/version_%j/slurm_out/%j.out	     # Redirect standard out to slurm_outs
#SBATCH --error=logs/esm_mlm_gcn/version_%j/slurm_out/%j.err	     # Redirect standard err to slurm_outs
...
# Run
srun python lightning-esm_mlm_gcn.py \

    ...
    def __init__(self, 
        ...
        if from_esm_mlm is not None:
            ...
            ignored_missing = {
                ...
                "gcn.fcn.0.weight", "gcn.fcn.0.bias", "gcn.fcn.2.weight", "gcn.fcn.2.bias", "gcn.fcn.4.weight", "gcn.fcn.4.bias",
                "gcn.fcn.6.weight", "gcn.fcn.6.bias", "gcn.fcn.8.weight", "gcn.fcn.8.bias", "gcn.output.weight", "gcn.output.bias"
            }

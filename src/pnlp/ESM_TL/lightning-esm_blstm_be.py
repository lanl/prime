#!/usr/bin/env python
"""
PyTorch Lightning ESM-BLSTM BE model runner.
"""
import argparse
import os
import time
...
class LightningEsmBlstmBe(L.LightningModule):
    def __init__(self, 
                 ...
                 lr: float, max_len: int, blstm_model: BLSTM_BE, esm_version="facebook/esm2_t6_8M_UR50D", freeze_esm_weights=False, from_esm_mlm=None):
        super().__init__()
        ...
        if from_esm_mlm is not None:
            ...
            # Define keys to ignore in missing list, these are from ESM_BLSTM BE and won't exist in the ESM_MLM
            ignored_missing = {

...
#SBATCH --output=logs/bert_gcn_be/version_%j/slurm_out/%j.out	 # Redirect standard out to slurm_outs
#SBATCH --error=logs/bert_gcn_be/version_%j/slurm_out/%j.err	 # Redirect standard err to slurm_outs
...
# Run
srun python lightning-bert_gcn_be.py \
--num_epochs 5 \
--lr 1e-5

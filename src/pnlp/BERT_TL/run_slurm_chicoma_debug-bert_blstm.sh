...
#SBATCH --output=logs/bert_blstm_be/version_%j/slurm_out/%j.out	 # Redirect standard out to slurm_outs
#SBATCH --error=logs/bert_blstm_be/version_%j/slurm_out/%j.err	 # Redirect standard err to slurm_outs
...
# Run
srun python lightning-bert_blstm_be.py \
--num_epochs 20 \
--lr 1e-4 
